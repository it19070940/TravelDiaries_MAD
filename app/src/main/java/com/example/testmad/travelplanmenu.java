...
public class travelplanmenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_travelplanmenu);
        ...
        viewtrav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(travelplanmenu.this,viewplan.class));
                finish();
            }
        });
    }
